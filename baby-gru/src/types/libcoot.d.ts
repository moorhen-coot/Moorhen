...
export namespace libcootApi {
    ...
    type DNATCONtcStepParameters = {
        step_id: string;
        tor_delta_1: string;
        tor_epsilon_1: string;
        tor_zeta_1: string;
        tor_alpha_2: string;
        tor_beta_2: string;
        tor_gamma_2: string;
        ...
        dist_CC: string;
        tor_NCCN: string;
        diff_tor_delta_1: string;
        diff_tor_epsilon_1: string;
        diff_tor_zeta_1: string;
        diff_tor_alpha_2: string;
        diff_tor_beta_2: string;
        diff_tor_gamma_2: string;
        diff_tor_delta_2: string;
        diff_tor_chi_1: string;
        diff_tor_chi_2: string;
        diff_dist_NN: string;
        diff_dist_CC: string;
        diff_tor_NCCN: string;
        confal_tor_delta_1: string;
        confal_tor_epsilon_1: string;
        confal_tor_zeta_1: string;
        confal_tor_alpha_2: string;
        confal_tor_beta_2: string;
        confal_tor_gamma_2: string;
        confal_tor_delta_2: string;
        confal_tor_chi_1: string;
        confal_tor_chi_2: string;
        confal_dist_NN: string;
        confal_dist_CC: string;
        confal_tor_NCCN: string;
        details: string;
    };
