...
/** @type {Object} */
     ...
     */
    const unProject = function(winX, winY, winZ, model, proj, view, objPos) {
     ...
     */
    const multMatrixVec = function(matrix, inp, out) {
     ...
     */
    const multMatrices = function(a, b, r) {
        for (var i = 0; i < 4; i = i + 1) {
     ...
     */
    const invertMatrix = function(m, invOut) {
        /** @type {Array.<number>} */
        var inv = [];
