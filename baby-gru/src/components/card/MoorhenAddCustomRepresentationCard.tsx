        ...
        return (
            ...
            >
                <Stack gap={2} direction="vertical" style={{ width: "25rem", margin: "0.5rem" }}>
                    ...
                    {!useDefaultRepresentationSettings && (representationStyle!=="MetaBalls") && COOT_BOND_REPRESENTATIONS.includes(representationStyle) && (
                    ...
                    {!useDefaultColours && (
                        <>
                            ...
                            >
                                <Form.Group
                                    style={{ paddingLeft: "0.5rem", paddingRight: "0.5rem", width: "100px" }}
                                    controlId="MoorhenMoleculeNonCustomAlphaSlider"
                                >
                                    <MoorhenSlider
                                        minVal={0.0}
                                        maxVal={1.0}
