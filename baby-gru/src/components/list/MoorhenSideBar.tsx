...
import { MoorhenToolsAccordion } from '../validation-tools/MoorhenToolsAccordion'
import { MoorhenDisplayObjects } from './MoorhenDisplayObjects';
import { MoorhenConsole } from"../misc/MoorhenConsole";
...
export const MoorhenSideBar = forwardRef<HTMLDivElement, MoorhenSideBarPropsInterface>((props, ref) => {
    ...
    return <>
        <Drawer anchor='right' open={true} variant='persistent'
            ...
            <IconButton id='open-sidebar-button' onMouseOver={() => setOpacity(1)} onMouseOut={() => setOpacity(0.5)} onClick={() => {setShowSideBar(true)}} sx={{
