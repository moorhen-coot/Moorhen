...
export const MoorhenMrBumpModal = () => {
    ...
    //                     } else {
    //                         pic_domains[this_model_json.RID] = [
    //                             [this_model_json.modelName],
    //                             [this_model_json.tarGroupStart, this_model_json.tarGroupEnd],
    //                         ];
    //                     }
    //                 }
    //             }
    ...
    //                         const domain = fullName
    //                             .substring(fullName.lastIndexOf("models/range_") + "models/range_".length)
    //                             .substring(0, domStart);
    ...
    //             drawPromises.push(newMolecule.molecule.fetchIfDirtyAndDraw(newMolecule.molecule.atomCount >= 50000 ? "CRs" : "CBs"));
    //         }
    ...
    //                             loadMrBumpFiles(e.target.files);
    //                         }}
    //                     />
    //                 </Form.Group>
    //             </MoorhenStack>
    ...
    //                     <Card.Footer>
    //                         <Typography gutterBottom style={{ display: "flex", justifyContent: "left" }}>
    //                             Variance
    //                         </Typography>
    //                         <Slider aria-label="Small steps" defaultValue={110} step={10} marks min={10} max={110} valueLabelDisplay="auto" />
    //                     </Card.Footer>
    //                 </Card>
    //             </ListGroup.Item>
    //         );
    ...
    return (
        <MoorhenDraggableModalBase
            ...
            body={
                <>
                    <MoorhenTabContainer>
                        <MoorhenTab id="tab-1" label="Domains">
                            <div />
                            {/* {Object.entries(mrBumpDomains).length > 0 && <ListGroup>{domains}</ListGroup>} */}
                        </MoorhenTab>
                        <MoorhenTab id="tab-2" label="Ranges">
                            <div />
                            {/* <canvas
                                ref={canvasRef}
