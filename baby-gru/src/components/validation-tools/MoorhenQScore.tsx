...
import { setHoveredAtom } from "@/store";
...
export const MoorhenQScore = () => {
    ...
    ): Promise<libcootApi.ValidationInformationJS[]> => {
    ...
    const getSequenceData = useCallback(
        (selectedMolNo: number, selectedChain: string) => {
    ...
    return <MoorhenValidationChartWidgetBase ref={chartRef} fetchData={fetchData} getChart={getChart} chartId={"qscore-plot-chart"} />;
};
