...
>((props, ref) => {
    ...
    useEffect(() => {
        const doRotamerChange = async () => {
            ...
            selectedFragmentRef.current.cid = `//${props.chosenAtom.chain_id}/${props.chosenAtom.res_no}/*${props.chosenAtom.alt_conf === "" ? "" : ":" + props.chosenAtom.alt_conf}`
            ...
            setTimeout(async () => {
                ...
                await Promise.all(selectedMolecule.representations
