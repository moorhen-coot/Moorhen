...
export const MoorhenSetOccupancyMenuItem = (props) => {
        ...
        <>
            ...
            <Form.Group style={{ width: "100%", margin: 0 }}>
                <TextField
                    ...
                    variant="standard"
                    error={
                        isNaN(parseFloat(occupancy)) || parseFloat(occupancy) < 0 || parseInt(occupancy) === Infinity
                    }
                    value={occupancy}
                    inputProps={{
                        step: ".1",
    ...
    return (
        <MoorhenBaseMenuItem
            id="occupancy-menu-item"
            popoverPlacement="right"
            popoverContent={panelContent}
            menuItemText="Set occupancy..."
            onCompleted={() => {}}
            showOkButton={false}
