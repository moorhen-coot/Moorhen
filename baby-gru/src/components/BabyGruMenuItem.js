...
export const BabyGruLoadTutorialDataMenuItem = (props) => {
    ...
    const onCompleted = () => {
        ...
        newMolecule.loadToCootFromURL(`${props.homepage}/baby-gru/tutorials/moorhen-tutorial-structure-number-${tutorialNumber}.pdb`, `moorhen-tutorial-${tutorialNumber}`)
            .then(result => {
                ...
                return newMap.loadToCootFromMtzURL(`${props.homepage}/baby-gru/tutorials/moorhen-tutorial-map-number-${tutorialNumber}.mtz`, `moorhen-tutorial-${tutorialNumber}`,
                ...
                return newDiffMap.loadToCootFromMtzURL(`${props.homepage}/baby-gru/tutorials/moorhen-tutorial-map-number-${tutorialNumber}.mtz`, `moorhen-tutorial-${tutorialNumber}`,
...
export const BabyGruImportDictionaryMenuItem = (props) => {
    ...
    const readMonomerFile = async (newTlc) => {
        console.log({ newTlc })
        return fetch(`${props.homepage}/baby-gru/monomers/${newTlc.toLowerCase()[0]}/${newTlc.toUpperCase()}.cif`)
