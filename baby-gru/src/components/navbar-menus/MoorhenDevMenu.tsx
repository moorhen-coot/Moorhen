...
export const MoorhenDevMenu = (props: { dropdownId: string }) => {
    ...
    const loadExampleOverlays = async (evt) => {
        ...
        if (evt.target.checked) {
            ...
            dispatch(
                addImageOverlay({
                    src: `${props.urlPrefix}/pixmaps/axes_xyz.svg`,
                    x: 0.35,
                    y: 0.75,
                    width: 100,
                    height: 100,
            ...
            dispatch(
                addImageOverlay({
                    src: `${props.urlPrefix}/pixmaps/MoorhenLogo.png`,
                    x: 0.75,
                    y: 0.15,
                    width: 30,
                    height: 30,
            ...
            dispatch(addLatexOverlay({ zIndex: 1, text: input, x: 0.3, y: 0.25, height: 60, uniqueId: uuidv4() }));
            dispatch(addLatexOverlay({ text: input2, x: 0.4, y: 0.65, height: 80, uniqueId: uuidv4() }));
        }
    };
