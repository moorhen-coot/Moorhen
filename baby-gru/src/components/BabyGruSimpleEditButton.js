...
const BabyGruSimpleEditButton = forwardRef((props, buttonRef) => {
...
export const BabyGruAutofitRotamerButton = (props) => {
    return <BabyGruSimpleEditButton {...props}
        ...
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/auto-fit-rotamer.svg`} />}
...
export const BabyGruFlipPeptideButton = (props) => {
    return <BabyGruSimpleEditButton {...props}
        ...
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/flip-peptide.svg`} />}
        formatArgs={(molecule, chosenAtom) => {
...
export const BabyGruConvertCisTransButton = (props) => {
    return <BabyGruSimpleEditButton {...props}
        ...
        icon={<img className="baby-gru-button-icon" alt="Cis/Trans" src={`${props.homepage}/baby-gru/pixmaps/cis-trans.svg`} />}
        formatArgs={(molecule, chosenAtom) => {
            return [molecule.molNo, `//${chosenAtom.chain_id}/${chosenAtom.res_no}/${chosenAtom.atom_name}${
...
export const BabyGruSideChain180Button = (props) => {
    return <BabyGruSimpleEditButton {...props}
        ...
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/side-chain-180.svg`} />}
        formatArgs={(molecule, chosenAtom) => {
...
export const BabyGruRefineResiduesUsingAtomCidButton = (props) => {
    ...
    return <BabyGruSimpleEditButton {...props}
        ...
        prompt={<BabyGruRefinementPanel
            ...
            panelParameters={panelParameters} />}
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/refine-1.svg`} />}
...
export const BabyGruAddSideChainButton = (props) => {
    return <BabyGruSimpleEditButton {...props}
        ...
        icon={<img className="baby-gru-button-icon" alt="Add side chain" src={`${props.homepage}/baby-gru/pixmaps/add-sidechain.svg`} />}
        formatArgs={(molecule, chosenAtom) => {
...
export const BabyGruDeleteUsingCidButton = (props) => {
    ...
    return <BabyGruSimpleEditButton {...props}
        ...
        prompt={<BabyGruDeletePanel
            setPanelParameters={setPanelParameters}
            panelParameters={panelParameters} />}
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/delete.svg`} />}
...
export const BabyGruMutateButton = (props) => {
    ...
    return <BabyGruSimpleEditButton {...props}
        ...
        prompt={<BabyGruMutatePanel
            setPanelParameters={setPanelParameters}
            panelParameters={panelParameters} />}
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/mutate.svg`} />}
...
export const BabyGruAddTerminalResidueDirectlyUsingCidButton = (props) => {
    return <BabyGruSimpleEditButton {...props}
        ...
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/add-peptide-1.svg`} />}
        formatArgs={(molecule, chosenAtom) => {
            return [molecule.molNo, `//${chosenAtom.chain_id}/${chosenAtom.res_no}`]
        }} />
}
...
export const BabyGruEigenFlipLigandButton = (props) => {
    return <BabyGruSimpleEditButton {...props}
        ...
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/spin-view.svg`} />}
        formatArgs={(molecule, chosenAtom) => {
            return [molecule.molNo, `//${chosenAtom.chain_id}/${chosenAtom.res_no}`]
        }} />
}
...
export const BabyGruJedFlipFalseButton = (props) => {
    return <BabyGruSimpleEditButton {...props}
        ...
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/edit-chi.svg`} />}
        formatArgs={(molecule, chosenAtom) => {
...
export const BabyGruJedFlipTrueButton = (props) => {
    return <BabyGruSimpleEditButton {...props}
        ...
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/jed-flip-reverse.svg`} />}
        formatArgs={(molecule, chosenAtom) => {
...
export const BabyGruRotateTranslateZoneButton = (props) => {
    ...
    return <><BabyGruSimpleEditButton ref={theButton} {...props}
        ...
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/rtz.svg`} />}
        formatArgs={(molecule, chosenAtom) => {
            return [molecule.molNo, `//${chosenAtom.chain_id}/${chosenAtom.res_no}/${chosenAtom.atom_name}`, true]
        }} />
...
export const BabyGruAddSimpleButton = (props) => {
    ...
    return <BabyGruSimpleEditButton {...props}
        ...
        />}
        icon={<img className="baby-gru-button-icon" src={`${props.homepage}/baby-gru/pixmaps/atom-at-pointer.svg`} />}
    />
}
