 ...
 * @property {boolean} [doSSAO=false] - Indicates if ambient occlusion should be done
...
const MoorhenContextProvider = ({ children }) => {
    ...
    const [doSSAO, setDoSSAO] = useState<null | boolean>(null)
    const [ssaoRadius, setSsaoRadius] = useState<null | number>(null)
    const [ssaoBias, setSsaoBias] = useState<null | number>(null)
    ...
    useMemo(() => {
        ...
        updateStoredContext('ssaoBias', ssaoBias);
    }, [ssaoBias]);
    ...
    useMemo(() => {
        ...
        updateStoredContext('ssaoRadius', ssaoRadius);
    }, [ssaoRadius]);
    ...
    useMemo(() => {
        ...
        updateStoredContext('doSSAO', doSSAO);
    }, [doSSAO]);
    ...
    const collectedContextValues: moorhen.Context = {
        ...
        doSSAO, setDoSSAO, ssaoBias, setSsaoBias, ssaoRadius, setSsaoRadius
    }
