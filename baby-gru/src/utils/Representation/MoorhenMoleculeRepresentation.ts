...
import { centreOnGemmiAtoms, cidToSpec, copyStructureSelection, countResiduesInSelection, gemmiAtomPairsToCylindersInfo, gemmiAtomsToCirclesSpheresInfo, getCubeLines, guid, hexToRGB, extendCuboidMesh } from "../utils";
...
export class MoleculeRepresentation {
    ...
    */
    ...
    getGemmiAtomPairsBuffers(
        ...
        const objects = [{...gemmiAtomPairsToCylindersInfo(gemmiAtomPairs, size, atomColours, labelled, minDist, maxDist,dashed),pick_info:{}}];
        return objects;
    }
    ...
    /**
     * Get representation buffers for the DNATCO representation
     * @param {string} cid - The CID selection for this representation
     * @returns {libcootApi.SimpleMeshJS[]} The representation buffers
     */
