...
const initialState: {
    imageOverlayList: ImageSrcFrac[];
    textOverlayList: TextFrac[];
    svgPathOverlayList: SvgPath[];
    fracPathOverlayList: FracPath[];
    callBacks: Function[];
} = {
    imageOverlayList: [],
    textOverlayList: [],
...
export const { addImageOverlay, addTextOverlay, addSvgPathOverlay, addFracPathOverlay, emptyOverlays, addCallback } =
