...
EMSCRIPTEN_BINDINGS(gemmi_data) {
    ...
    //.property("verbose",&gemmi::CifToMtz::verbose) //Seems to be gone 0.7.5
    ...
    class_<gemmi::MtzMetadata>("MtzMetadata")
    .property("source_path",&gemmi::MtzMetadata::source_path)
    .property("indices_switched_to_original",&gemmi::MtzMetadata::indices_switched_to_original)
    .property("nreflections",&gemmi::MtzMetadata::nreflections)
    .property("header_offset",&gemmi::MtzMetadata::header_offset)
    .property("version_stamp",&gemmi::MtzMetadata::version_stamp)
    .property("same_byte_order",&gemmi::MtzMetadata::same_byte_order)
    .property("sort_order",&gemmi::MtzMetadata::sort_order)//std::array<int, 5>
    .property("title",&gemmi::MtzMetadata::title)
    .property("nsymop",&gemmi::MtzMetadata::nsymop)
    .property("symops",&gemmi::MtzMetadata::symops)
    .property("min_1_d2",&gemmi::MtzMetadata::min_1_d2)
    .property("max_1_d2",&gemmi::MtzMetadata::max_1_d2)
    .property("cell",&gemmi::MtzMetadata::cell)
    .property("spacegroup_number",&gemmi::MtzMetadata::spacegroup_number)
    .property("valm",&gemmi::MtzMetadata::valm)
    .property("history",&gemmi::MtzMetadata::history)
    .property("appended_text",&gemmi::MtzMetadata::appended_text)
    .property("spacegroup_name",&gemmi::MtzMetadata::spacegroup_name)
    ;

    class_<gemmi::Mtz, base<gemmi::MtzMetadata>>("Mtz")
