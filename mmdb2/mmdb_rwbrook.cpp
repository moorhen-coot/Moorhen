...
FORTRAN_SUBR ( MMDB_F_ATOM,  mmdb_f_atom,
           (    // lengths-at-end list
            ...
            mmdb::machine::fpstr InsCod, mmdb::machine::fpstr_size_t   InsCod_len,
...
FORTRAN_SUBR ( MMDB_F_WREMARK, mmdb_f_wremark,
               (    // lengths-at-end list
                ...
                int * iUnit, mmdb::machine::fpstr Line, mmdb::machine::fpstr_size_t Line_len, int *iRet
               )
             )  {
int  k;
char S[500];
...
FORTRAN_SUBR ( HY36ENCODE_F, hy36encode_f,
               (const int *iwidth, int *value,
                mmdb::machine::fpstr strval, mmdb::machine::fpstr_size_t strval_len),
               (const int *iwidth, int *value,
...
FORTRAN_SUBR ( HY36DECODE_F, hy36decode_f,
               (const int *iwidth,
                mmdb::machine::fpstr strval, int *value, mmdb::machine::fpstr_size_t strval_len),
               (const int *iwidth,
                mmdb::machine::fpstr strval, int *value),
               (const int *iwidth,
                mmdb::machine::fpstr strval, mmdb::machine::fpstr_size_t strval_len, int *value))
