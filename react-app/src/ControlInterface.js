        ...
        return (
            ...
            >
                ...
                <Tab eventKey="utilities" title="Utilities">
                    <Utilities onResidueDataClick={this.props.onResidueDataClick} bvalRef={this.props.bvalRef} densityFitRef={this.props.densityFitRef} displayData={displayData} sharedArrayBuffer={this.props.sharedArrayBuffer} crystWorker={this.props.crystWorker} dataFiles={dataFiles} onSVGChange={this.svgChanged.bind(this)} mapChanged={this.mapChanged.bind(this)} filePendingChanged={this.filePendingChanged.bind(this)} helicesChanged={this.helicesChanged.bind(this)} />
                </Tab>
            </Tabs>
        );
    }
