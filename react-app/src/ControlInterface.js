...
import AutoFitRotamer from './AutoFitRotamer';
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <Tab eventKey="autoFitRotamerTab" title="Auto Fit Rotamer">
                    <AutoFitRotamer ref={this.props.rsrRef} dataObjectsNames={this.props.dataObjectsNames}  crystWorker={this.props.crystWorker} addRequest={this.addRequested.bind(this)} liveUpdatingMaps={liveUpdatingMaps} dataFiles={dataFiles} displayData={displayData} mapDataFiles={mapDataFiles} onPDBChange={this.filePendingChanged.bind(this)} />
                </Tab>
