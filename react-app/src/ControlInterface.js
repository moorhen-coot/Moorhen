...
class ControlInterface extends Component {
    ...
    render () {
        ...
        return (
                ...
                <MGWebWizardUI  enerLib={enerLib} onGlycanChange={this.glycanChanged.bind(this)} onSVGChange={this.svgChanged.bind(this)} onChange={this.filePendingChanged.bind(this)} />
                </Tab>
