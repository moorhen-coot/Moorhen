...
class AutoFitRotamer extends Component {
    constructor(props) {
        ...
        this.state = {selected:"unk",mapSelected:"unk",log:"", chainId:"", startRes:0 };
        this.jobData = {};
        this.message = "";
        const self = this;
    }
    ...
    handleRSR(){
        ...
        const jobid = guid();
        const inputData = {method:"auto_fit_rotamer",jobId:jobid,pdbinKey:key,hklinKey:keyMap,chainId:this.state.chainId,resno:parseInt(this.state.startRes)};
